...
@Controller('jf/directors-sheets')
export class DirectorsControllerSheets {
  private readonly logger = new Logger(DirectorsControllerSheets.name);
  ...
  async addDirector(
    ...
    try {
      ...
      const director = await this.usersService.addDirector({
        ...
        'Phone Number': directorData['Phone Number'],
